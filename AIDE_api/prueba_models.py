...
from sqlalchemy import String, Text, Boolean, Integer, Column, ForeignKey, Float, Time
...
class Tutor(Base):
    ...
    seniors=relationship('Senior', cascade='all, delete, delete-orphan')
...
class Senior(Base):
    ...
    tutor_id = Column("tutor_id",Integer, ForeignKey("tutor.id", ondelete="CASCADE", onupdate="CASCADE"), nullable=False) # is_associated_with
    
    customized_activities = relationship("CustomizedAct", cascade='all, delete, delete-orphan')
    reports = relationship("ReportActivity", cascade='all, delete, delete-orphan')
...
class CustomizedAct(Base):
    ...
    senior_id = Column("senior_id", Integer, ForeignKey("senior.id", ondelete="CASCADE", onupdate="CASCADE"), nullable=False)
...
class ReportActivity(Base):
    ...
    senior_id = Column("senior_id", Integer, ForeignKey("senior.id", ondelete="CASCADE", onupdate="CASCADE"), nullable=False)
    activity_id = Column("activity_id", Integer, ForeignKey("activity.id", ondelete="CASCADE", onupdate="CASCADE"), nullable=False)
...
class Position(Base):
    ...
    id_photo = Column("id_photo", Integer, ForeignKey("photo.id", ondelete="CASCADE", onupdate="CASCADE"), primary_key=True, nullable=False)
    id_person = Column("id_person", Integer, ForeignKey("person.id", ondelete="CASCADE", onupdate="CASCADE"), primary_key=True, nullable=False) 
...
class PhotoCustomized(Base):
    ...
    id_photo = Column("id_photo", Integer, ForeignKey("photo.id", ondelete="CASCADE", onupdate="CASCADE"), primary_key=True, nullable=False)
    id_activity = Column("id_activity", Integer, ForeignKey("activity.id", ondelete="CASCADE", onupdate="CASCADE"), primary_key=True, nullable=False)
...
class SeniorActivity(Base):
    ...
    id_senior = Column("id_senior", Integer, ForeignKey("senior.id", ondelete="CASCADE", onupdate="CASCADE"), primary_key=True, nullable=False)
    id_activity = Column("id_activity", Integer, ForeignKey("activity.id", ondelete="CASCADE", onupdate="CASCADE"), primary_key=True, nullable=False)
...
Position = Table('position', Base.metadata,
...
PhotoCustomized = Table('photo_customized', Base.metadata,
    id_photo = Column("id_photo", Integer, ForeignKey("photo.id"), primary_key=True, nullable=False),
    id_activity = Column("id_activity", Integer, ForeignKey("activity.id"), primary_key=True, nullable=False)

)

SeniorActivity = Table('senior_activity', Base.metadata,
